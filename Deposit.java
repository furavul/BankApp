...
public class Deposit extends DBcon {
    ...
    public void deposit() throws SQLException, IOException {
        ...
        Connection c = DriverManager.getConnection("jdbc:MySQL://localhost:3306/bankdb?user=root&password=123456");
        ...
        try {
            Connection d = DriverManager.getConnection("jdbc:MySQL://localhost:3306/bankdb?user=root&password=123456");
